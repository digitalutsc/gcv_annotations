...
def main():
    ...
    out_json["@id"] = "https://core.digital.utsc.utoronto.ca/" + OUTPUT_PATH
    ...
    for page in in_json["fullTextAnnotation"]["pages"]:
        for block in page["blocks"]:
            ...
            for paragraph in block["paragraphs"]:
                ...
                resources = {}
                resources["@id"] = "https://dsu-data.utsc.utoronto.ca:8443/simpleAnnotationStore/annotation/" + str(hash(json.dumps(paragraph, sort_keys=True)))
